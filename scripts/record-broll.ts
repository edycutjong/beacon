...
async function runBRoll() {
  console.log('🎥 Starting Pulse B-Roll Recording...');
  ...
  await typeLikeUser(page, '#sweep-input', 'Routing Request: Run model classification on 12MB sensory log bundle from Remote Node #82.');
  await page.waitForTimeout(1000);
  ...
  if (videoPath) {
    const finalPath = path.join('/Users/edycu/Projects/DemoStudio/public/projects/Pulse', 'Pulse_BRoll.webm');
